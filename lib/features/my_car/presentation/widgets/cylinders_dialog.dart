...
class CylindersDialog extends StatefulWidget {
  final Function(String)? onItemSelected;

  const CylindersDialog({super.key, this.onItemSelected});

  @override
  State<CylindersDialog> createState() => _TranmissionDialogState();
}

class _TranmissionDialogState extends State<CylindersDialog> {
  @override
  ...
  final List<String> _cylinders =
      List.from(Cylinders.values.map((e) => e.displayName));
