...
abstract class $PaginationModelCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T data, Links links, Meta meta, String message});
...
class _$PaginationModelImpl<T> extends _PaginationModel<T> {
  ...
  @override
  String toString() {
    return 'PaginationModel<$T>(data: $data, links: $links, meta: $meta, message: $message)';
  }
...
abstract class _PaginationModel<T> extends PaginationModel<T> {
  const factory _PaginationModel(
      ...
      required final String message}) = _$PaginationModelImpl<T>;
